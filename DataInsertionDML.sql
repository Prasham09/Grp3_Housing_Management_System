...
INSERT INTO HMS_ADMIN.BROKER (admin_id, name, email, phone, broker_license_number) VALUES (1,'Michael Roberts','mroberts@bostonbrokers.com','617-555-1001','LIC-1001');
INSERT INTO HMS_ADMIN.BROKER (admin_id, name, email, phone, broker_license_number) VALUES (2,'Jennifer Lee','jlee@bostonbrokers.com','617-555-1002','LIC-1002');
INSERT INTO HMS_ADMIN.BROKER (admin_id, name, email, phone, broker_license_number) VALUES (3,'David Chang','dchang@bostonbrokers.com','617-555-1003','LIC-1003');
INSERT INTO HMS_ADMIN.BROKER (admin_id, name, email, phone, broker_license_number) VALUES (4,'Maria Gonzalez','mgonzalez@bostonbrokers.com','617-555-1004','LIC-1004');
INSERT INTO HMS_ADMIN.BROKER (admin_id, name, email, phone, broker_license_number) VALUES (5,'Robert Williams','rwilliams@bostonbrokers.com','617-555-1005','LIC-1005');
INSERT INTO HMS_ADMIN.BROKER (admin_id, name, email, phone, broker_license_number) VALUES (6,'Aisha Khan','akhan@bostonbrokers.com','617-555-1006','LIC-1006');
INSERT INTO HMS_ADMIN.BROKER (admin_id, name, email, phone, broker_license_number) VALUES (7,'Carlos Romano','cromano@bostonbrokers.com','617-555-1007','LIC-1007');
INSERT INTO HMS_ADMIN.BROKER (admin_id, name, email, phone, broker_license_number) VALUES (8,'Priya Patel','ppetel@bostonbrokers.com','617-555-1008','LIC-1008');
INSERT INTO HMS_ADMIN.BROKER (admin_id, name, email, phone, broker_license_number) VALUES (9,'Liam O''Connor','loconnor@bostonbrokers.com','617-555-1009','LIC-1009');
INSERT INTO HMS_ADMIN.BROKER (admin_id, name, email, phone, broker_license_number) VALUES (10,'Emily Park','epark@bostonbrokers.com','617-555-1010','LIC-1010');
COMMIT;
...
INSERT INTO HMS_ADMIN.PROPERTY (owner_id, broker_id, title, address, city, rent, availability_status, type, description, amenities)
...
-- BROKER_PROPERTY (25)
-- ===========================
INSERT INTO HMS_ADMIN.BROKER_PROPERTY (broker_id, property_id, assigned_date, is_active) VALUES (1,1,DATE '2024-01-15','N');
INSERT INTO HMS_ADMIN.BROKER_PROPERTY (broker_id, property_id, assigned_date, is_active) VALUES (2,1,DATE '2024-02-01','N');
INSERT INTO HMS_ADMIN.BROKER_PROPERTY (broker_id, property_id, assigned_date, is_active) VALUES (1,1,DATE '2025-01-15','Y');
INSERT INTO HMS_ADMIN.BROKER_PROPERTY (broker_id, property_id, assigned_date, is_active) VALUES (2,2,DATE '2024-05-10','N');
INSERT INTO HMS_ADMIN.BROKER_PROPERTY (broker_id, property_id, assigned_date, is_active) VALUES (3,2,DATE '2024-06-01','Y');
INSERT INTO HMS_ADMIN.BROKER_PROPERTY (broker_id, property_id, assigned_date, is_active) VALUES (3,3,DATE '2024-02-20','Y');
INSERT INTO HMS_ADMIN.BROKER_PROPERTY (broker_id, property_id, assigned_date, is_active) VALUES (4,4,DATE '2023-09-01','N');
INSERT INTO HMS_ADMIN.BROKER_PROPERTY (broker_id, property_id, assigned_date, is_active) VALUES (5,4,DATE '2024-03-01','Y');
INSERT INTO HMS_ADMIN.BROKER_PROPERTY (broker_id, property_id, assigned_date, is_active) VALUES (6,5,DATE '2024-04-10','N');
INSERT INTO HMS_ADMIN.BROKER_PROPERTY (broker_id, property_id, assigned_date, is_active) VALUES (7,5,DATE '2024-06-15','N');
INSERT INTO HMS_ADMIN.BROKER_PROPERTY (broker_id, property_id, assigned_date, is_active) VALUES (5,5,DATE '2025-02-10','Y');
INSERT INTO HMS_ADMIN.BROKER_PROPERTY (broker_id, property_id, assigned_date, is_active) VALUES (8,6,DATE '2024-07-01','Y');
INSERT INTO HMS_ADMIN.BROKER_PROPERTY (broker_id, property_id, assigned_date, is_active) VALUES (9,7,DATE '2024-08-05','Y');
INSERT INTO HMS_ADMIN.BROKER_PROPERTY (broker_id, property_id, assigned_date, is_active) VALUES (10,8,DATE '2024-09-15','Y');
INSERT INTO HMS_ADMIN.BROKER_PROPERTY (broker_id, property_id, assigned_date, is_active) VALUES (2,9,DATE '2024-10-02','Y');
INSERT INTO HMS_ADMIN.BROKER_PROPERTY (broker_id, property_id, assigned_date, is_active) VALUES (1,10,DATE '2025-01-04','Y');
INSERT INTO HMS_ADMIN.BROKER_PROPERTY (broker_id, property_id, assigned_date, is_active) VALUES (3,11,DATE '2024-03-22','Y');
INSERT INTO HMS_ADMIN.BROKER_PROPERTY (broker_id, property_id, assigned_date, is_active) VALUES (4,12,DATE '2024-02-12','Y');
INSERT INTO HMS_ADMIN.BROKER_PROPERTY (broker_id, property_id, assigned_date, is_active) VALUES (5,6,DATE '2023-12-01','N');
INSERT INTO HMS_ADMIN.BROKER_PROPERTY (broker_id, property_id, assigned_date, is_active) VALUES (6,7,DATE '2023-11-11','N');
INSERT INTO HMS_ADMIN.BROKER_PROPERTY (broker_id, property_id, assigned_date, is_active) VALUES (7,8,DATE '2024-01-10','N');
INSERT INTO HMS_ADMIN.BROKER_PROPERTY (broker_id, property_id, assigned_date, is_active) VALUES (8,9,DATE '2024-05-05','N');
INSERT INTO HMS_ADMIN.BROKER_PROPERTY (broker_id, property_id, assigned_date, is_active) VALUES (9,10,DATE '2024-06-06','N');
INSERT INTO HMS_ADMIN.BROKER_PROPERTY (broker_id, property_id, assigned_date, is_active) VALUES (10,11,DATE '2024-07-07','N');
INSERT INTO HMS_ADMIN.BROKER_PROPERTY (broker_id, property_id, assigned_date, is_active) VALUES (1,12,DATE '2025-02-10','Y');
COMMIT;
